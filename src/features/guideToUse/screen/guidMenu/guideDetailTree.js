            ...
            <Container style={styles.container}>
                <Content>
                    ...
                    <View style={styles.viewAll}>
                        ...
                        />
                        <CommonText
                            text={'* ผู้ใช้จะต้องเปิดแสดงตำแหน่งของผู้ใช้แบบ\n "ความถูกต้องสูง" เท่านั้นจึงจะสามารถใช้งานได้\n\n'}
                            size={16}
                            weight={'400'}
                            color={'red'}
                            style={styles.label}
                        ...
                        <CommonText
                            ...
                            '* ผู้ใช้จะต้องเปิดแสดงตำแหน่งของผู้ใช้แบบ\n "ความถูกต้องสูง" เท่านั้นจึงจะสามารถใช้งานฟังก์ชันเส้นทางใกล้ที่สุดได้\n\n'}
                            size={16}
                            weight={'400'}
                            color={'red'}
                            style={styles.label}
